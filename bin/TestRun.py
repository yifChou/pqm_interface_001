...
def allInterfaceTests():
    print("路径信息：",os.path.join("./", 'tests', 'ots_interface'))
    suite =unittest.TestLoader().discover(
        start_dir=os.path.join("..\\", 'tests', 'ots_interface'),
        pattern='test_all*.py',
        top_level_dir=None
    )
...
def runInterface():
    ...
    fp = os.path.join(REPORT_JENKINS_PATH,getNowTime()+'testReport.html')
    '''
...
if __name__ == '__main__':
    ...
    #move_report()
    #print("路径信息：", os.path.join("./", 'tests', 'ots_interface'))
    #print(os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'tests', 'ots_interface')))
